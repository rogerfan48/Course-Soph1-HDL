...
## Switches
#set_property PACKAGE_PIN V17 [get_ports tag]
#set_property IOSTANDARD LVCMOS33 [get_ports tag]
#set_property PACKAGE_PIN V16 [get_ports ]
#set_property IOSTANDARD LVCMOS33 [get_ports ]
#set_property PACKAGE_PIN W16 [get_ports ]
#set_property IOSTANDARD LVCMOS33 [get_ports ]
#set_property PACKAGE_PIN W17 [get_ports {tune[3]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {tune[3]}]
#set_property PACKAGE_PIN W15 [get_ports {tune[4]}]
#set_property IOSTANDARD LVCMOS33 [get_ports {tune[4]}]
...
set_property IOSTANDARD LVCMOS33 [get_ports jiji]
set_property IOSTANDARD LVCMOS33 [get_ports nene]
set_property PACKAGE_PIN U16 [get_ports jiji]
set_property PACKAGE_PIN E19 [get_ports nene]

set_property IOSTANDARD LVCMOS33 [get_ports pigu]
set_property PACKAGE_PIN U19 [get_ports pigu]
