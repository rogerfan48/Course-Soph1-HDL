...
HD_PWD='C:/Users/sweri/Desktop/HD/roger/REWRITE/LAB3/FPGA/FPGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab3_FPGA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Lab3_FPGA.tcl -notrace
