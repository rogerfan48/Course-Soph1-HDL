...
HD_PWD='C:/Users/sweri/Desktop/HD/roger/REWRITE/LAB3/FPGA/FPGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Lab3_FPGA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Lab3_FPGA.tcl
