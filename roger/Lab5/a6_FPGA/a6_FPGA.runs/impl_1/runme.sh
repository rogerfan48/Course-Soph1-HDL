...
HD_PWD='C:/Users/sweri/Desktop/HD/roger/Lab5/a6_FPGA/a6_FPGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log Vender_Machine.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source Vender_Machine.tcl -notrace
