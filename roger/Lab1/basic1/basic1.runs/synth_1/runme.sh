...
HD_PWD='C:/Users/User/Desktop/Lab1/basic1/basic1.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log Mux_4x1_4bit_t.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source Mux_4x1_4bit_t.tcl
