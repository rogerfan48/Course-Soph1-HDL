...
HD_PWD='C:/Users/sweri/Desktop/HD/roger/Lab2/fpga/fpga.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log DAE_FPGA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source DAE_FPGA.tcl -notrace
