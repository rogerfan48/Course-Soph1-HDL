...
HD_PWD='C:/Users/sweri/Desktop/HD/roger/Lab2/fpga/fpga.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log DAE_FPGA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source DAE_FPGA.tcl
