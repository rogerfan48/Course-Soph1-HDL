...
HD_PWD='C:/Users/sweri/Desktop/HD/roger/Lab4/FPGA/FPGA.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log a3_FPGA.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source a3_FPGA.tcl
