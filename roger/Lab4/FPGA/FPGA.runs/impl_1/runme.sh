...
HD_PWD='C:/Users/sweri/Desktop/HD/roger/Lab4/FPGA/FPGA.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log a3_FPGA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source a3_FPGA.tcl -notrace
