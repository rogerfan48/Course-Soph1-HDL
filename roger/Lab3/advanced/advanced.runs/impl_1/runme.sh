...
HD_PWD='C:/Users/sweri/Desktop/HD/roger/Lab3/advanced/advanced.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log a5_FPGA.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source a5_FPGA.tcl -notrace
